...
},{}],"baseUrl.js":[function(require,module,exports) {
"use strict";
...
exports.Axios = Axios;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"updateFn.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.verifyEmailFn = exports.updateSettings = exports.signup = exports.logout = exports.login = exports.initializeImagePreview = exports.handlePostSubmit = exports.handlePaymentCallback = exports.formatNumber = exports.fetchTrafficData = exports.deleteItem = exports.createReview = exports.createItem = exports.createContactUs = exports.createComment = exports.addCategory = void 0;
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "POST",
            url: "".concat((0, _baseUrl.getBaseUrl)(), "/api/v1/users/login"),
            data: {
              email: email,
              password: password
            }
        ...
        case 3:
          ...
          if (res.data.status === "success") {
            ...
            (0, _alert.showAlert)("error", "Unexpected response from the server");
          }
          _context.next = 10;
          break;
        case 7:
          ...
          (0, _alert.showAlert)("error", _context.t0.response ? _context.t0.response.data.message : "Error logging in");
        case 10:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "GET",
            url: "".concat((0, _baseUrl.getBaseUrl)(), "/api/v1/users/logout")
          });
        case 3:
          res = _context2.sent;
          if (res.data.status === "success") {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "POST",
            url: "".concat((0, _baseUrl.getBaseUrl)(), "/api/v1/users/signup"),
            data: {
              name: name,
              email: email,
              password: password,
...
var updateSettings = exports.updateSettings = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(data, type) {
    var url, res;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          if (type === "password") {
            url = "".concat((0, _baseUrl.getBaseUrl)(), "/api/v1/users/updateMyPassword");
          } else if (type === "data") {
            url = "".concat((0, _baseUrl.getBaseUrl)(), "/api/v1/users/updateMe");
          } else if (type === "socials") {
            url = "".concat((0, _baseUrl.getBaseUrl)(), "/api/v1/socials/update-socials");
          }
          _context4.next = 4;
          return (0, _axios.default)({
            method: "PATCH",
  ...
  return function updateSettings(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
var createReview = exports.createReview = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(data, purchaseSecret) {
    var response;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          _context5.next = 3;
          return _axios.default.post("".concat((0, _baseUrl.getBaseUrl)(), "/api/v1/reviews?secret=").concat(purchaseSecret), data);
        case 3:
  ...
  return function createReview(_x9, _x10) {
    return _ref5.apply(this, arguments);
  };
}();
var verifyEmailFn = exports.verifyEmailFn = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(email, itemId) {
    var response, token;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          _context6.prev = 0;
          _context6.next = 3;
          return _axios.default.post("".concat((0, _baseUrl.getBaseUrl)(), "/api/v1/purchases/verify-email"), {
            email: email,
            itemId: itemId
          });
        case 3:
          ...
          if (response.data.status === "success") {
            token = response.data.data.token; // Redirect user to the download page with the purchase token
            window.location.href = "/payment-success/".concat(token);
          } else {
            // Handle the case where no purchase was found
            (0, _alert.showAlert)("error", "No purchase found with that email for this item.");
          }
          _context6.next = 11;
          break;
        case 7:
          ...
          if (_context6.t0.response) {
            if (_context6.t0.response.status === 400) {
              (0, _alert.showAlert)("error", "The token is invalid or has expired. Please request a new one.");
            } else {
              (0, _alert.showAlert)("error", "Something went wrong.");
            }
          } else {
            (0, _alert.showAlert)("error", "An unexpected error occurred. Please try again.");
          }
          (0, _alert.showAlert)("error", "Error verifying email:");
        case 11:
        case "end":
  ...
  return function verifyEmailFn(_x11, _x12) {
    return _ref6.apply(this, arguments);
  };
}();
var createComment = exports.createComment = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(postId, name, email, comment) {
    var response;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          _context7.prev = 0;
          _context7.next = 3;
          return _axios.default.post("".concat((0, _baseUrl.getBaseUrl)(), "/api/v1/comments"), {
            post: postId,
            name: name,
            email: email,
            comment: comment
  ...
  return function createComment(_x13, _x14, _x15, _x16) {
    return _ref7.apply(this, arguments);
  };
}();
var createContactUs = exports.createContactUs = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(name, email, message, contactForm) {
    var res;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          _context8.prev = 0;
          _context8.next = 3;
          return _axios.default.post("".concat((0, _baseUrl.getBaseUrl)(), "/api/v1/contact-us"), {
            name: name,
            email: email,
            message: message
          });
  ...
  return function createContactUs(_x17, _x18, _x19, _x20) {
    return _ref8.apply(this, arguments);
  };
}();
var createItem = exports.createItem = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        case 0:
          _context9.prev = 0;
          _context9.next = 3;
          return _axios.default.post("".concat((0, _baseUrl.getBaseUrl)(), "/api/v1/items"), formData, {
            headers: {
              "Content-Type": "multipart/form-data"
            }
          });
        case 3:
          res = _context9.sent;
          if (res.data.status === "created") {
            (0, _alert.showAlert)("success", "Item created successfully!");
          }
          _context9.next = 10;
          break;
        case 7:
  ...
  return function createItem(_x21) {
    return _ref9.apply(this, arguments);
  };
}();
var addCategory = exports.addCategory = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        case 0:
          _context10.prev = 0;
          _context10.next = 3;
          return _axios.default.post("".concat((0, _baseUrl.getBaseUrl)(), "/api/v1/categories"), data);
        case 3:
          res = _context10.sent;
          if (res.data.status === "created") {
            (0, _alert.showAlert)("success", "Category added successfully!");
          } else {
            (0, _alert.showAlert)("error", "Failed to add the category.");
          }
          _context10.next = 10;
          break;
        case 7:
  ...
  return function addCategory(_x22) {
    return _ref10.apply(this, arguments);
  };
}();
var fetchTrafficData = exports.fetchTrafficData = /*#__PURE__*/function () {
  var _ref11 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11() {
    var url, _yield$Promise$all, _yield$Promise$all2, dailyResponse, monthlyResponse, allTimeResponse;
    return _regeneratorRuntime().wrap(function _callee11$(_context11) {
      while (1) switch (_context11.prev = _context11.next) {
        case 0:
          _context11.prev = 0;
          url = "".concat((0, _baseUrl.getBaseUrl)(), "/api");
          _context11.next = 4;
          return Promise.all([_axios.default.get("".concat(url, "/traffic/daily")), _axios.default.get("".concat(url, "/traffic/monthly")), _axios.default.get("".concat(url, "/traffic/all-time"))]);
        case 4:
          _yield$Promise$all = _context11.sent;
          _yield$Promise$all2 = _slicedToArray(_yield$Promise$all, 3);
          dailyResponse = _yield$Promise$all2[0];
          monthlyResponse = _yield$Promise$all2[1];
          allTimeResponse = _yield$Promise$all2[2];
        ...
        case 12:
          ...
          (0, _alert.showAlert)("error", "Error fetching traffic data:", _context11.t0);
          return _context11.abrupt("return", {
            dailyCount: 0,
            monthlyCount: 0,
            allTimeCount: 0
  ...
  return function fetchTrafficData() {
    return _ref11.apply(this, arguments);
  };
}();
var handlePaymentCallback = exports.handlePaymentCallback = /*#__PURE__*/function () {
  var _ref12 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12(data, itemId, name, email, amount) {
    var reference, response, result, purchaseId, item, buyerEmail;
    return _regeneratorRuntime().wrap(function _callee12$(_context12) {
      while (1) switch (_context12.prev = _context12.next) {
        case 0:
          ...
          _context12.prev = 1;
          _context12.next = 4;
          return _axios.default.post("".concat((0, _baseUrl.getBaseUrl)(), "/api/v1/purchases/create-purchase"),
        ...
        case 4:
          ...
          if (result.status === "success") {
            ...
            buyerEmail = encodeURIComponent(response.data.data.buyerEmail); // Safely encode the email
            (0, _alert.showAlert)("success", "Payment complete! Reference: " + reference);
            window.location.href = "/redirect/".concat(purchaseId, "/").concat(item, "/").concat(buyerEmail);
          } else {
            (0, _alert.showAlert)("error", "Error processing payment. Please try again.");
          }
          _context12.next = 12;
          break;
        case 9:
  ...
  return function handlePaymentCallback(_x23, _x24, _x25, _x26, _x27) {
    return _ref12.apply(this, arguments);
  };
}();
var handlePostSubmit = exports.handlePostSubmit = /*#__PURE__*/function () {
  var _ref13 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13(title, content, excerpt, tags, category, photo, author, published, type) {
    var postId,
      formData,
      url,
      method,
    ...
    return _regeneratorRuntime().wrap(function _callee13$(_context13) {
      while (1) switch (_context13.prev = _context13.next) {
        case 0:
          postId = _args13.length > 9 && _args13[9] !== undefined ? _args13[9] : "";
          _context13.prev = 1;
          ...
          url = type === "create" ? "".concat((0, _baseUrl.getBaseUrl)(), "/api/v1/posts/submit-post") : "".concat((0, _baseUrl.getBaseUrl)(), "/api/v1/posts/").concat(postId);
        ...
        case 15:
          ...
          if (res.data.status === "success" || res.data.status === "created") {
            (0, _alert.showAlert)("success", "Post ".concat(type, "d successfully!"));
        ...
        case 19:
          ...
          (0, _alert.showAlert)("error", _context13.t0.response.data.message);
        case 22:
        case "end":
  ...
  return function handlePostSubmit(_x28, _x29, _x30, _x31, _x32, _x33, _x34, _x35, _x36) {
    return _ref13.apply(this, arguments);
  };
}();
var deleteItem = exports.deleteItem = /*#__PURE__*/function () {
  var _ref14 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(type, id) {
    var res, itemElement;
    return _regeneratorRuntime().wrap(function _callee14$(_context14) {
      while (1) switch (_context14.prev = _context14.next) {
        case 0:
          _context14.prev = 0;
          _context14.next = 3;
          return _axios.default.delete("".concat((0, _baseUrl.getBaseUrl)(), "/api/v1/").concat(type, "/").concat(id));
        case 3:
          res = _context14.sent;
          if (res.status === 204) {
            (0, _alert.showAlert)("success", "".concat(type, " deleted successfully!"));
            // Optionally, remove the deleted item from the DOM
            itemElement = document.querySelector(".".concat(type, "[data-id=\"").concat(id, "\"]"));
            if (itemElement) {
              itemElement.remove();
            } else {
              (0, _alert.showAlert)("error", "Element with selector .".concat(type, "[data-id=\"").concat(id, "\"] not found in the DOM."));
            }
          } else {
            (0, _alert.showAlert)("error", "Failed to delete the ".concat(type));
          }
          _context14.next = 10;
          break;
        case 7:
  ...
  return function deleteItem(_x37, _x38) {
    return _ref14.apply(this, arguments);
  };
}();
var initializeImagePreview = exports.initializeImagePreview = function initializeImagePreview(imgSelector, inputSelector) {
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js","./baseUrl":"baseUrl.js"}],"createProject.js":[function(require,module,exports) {
"use strict";
...
function _regeneratorRuntime() { "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ _regeneratorRuntime = function _regeneratorRuntime() { return e; }; var t, e = {}, r = Object.prototype, n = r.hasOwnProperty, o = Object.defineProperty || function (t, e, r) { t[e] = r.value; }, i = "function" == typeof Symbol ? Symbol : {}, a = i.iterator || "@@iterator", c = i.asyncIterator || "@@asyncIterator", u = i.toStringTag || "@@toStringTag"; function define(t, e, r) { return Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }), t[e]; } try { define({}, ""); } catch (t) { define = function define(t, e, r) { return t[e] = r; }; } function wrap(t, e, r, n) { var i = e && e.prototype instanceof Generator ? e : Generator, a = Object.create(i.prototype), c = new Context(n || []); return o(a, "_invoke", { value: makeInvokeMethod(t, r, c) }), a; } function tryCatch(t, e, r) { try { return { type: "normal", arg: t.call(e, r) }; } catch (t) { return { type: "throw", arg: t }; } } e.wrap = wrap; var h = "suspendedStart", l = "suspendedYield", f = "executing", s = "completed", y = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} var p = {}; define(p, a, function () { return this; }); var d = Object.getPrototypeOf, v = d && d(d(values([]))); v && v !== r && n.call(v, a) && (p = v); var g = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(p); function defineIteratorMethods(t) { ["next", "throw", "return"].forEach(function (e) { define(t, e, function (t) { return this._invoke(e, t); }); }); } function AsyncIterator(t, e) { function invoke(r, o, i, a) { var c = tryCatch(t[r], t, o); if ("throw" !== c.type) { var u = c.arg, h = u.value; return h && "object" == _typeof(h) && n.call(h, "__await") ? e.resolve(h.__await).then(function (t) { invoke("next", t, i, a); }, function (t) { invoke("throw", t, i, a); }) : e.resolve(h).then(function (t) { u.value = t, i(u); }, function (t) { return invoke("throw", t, i, a); }); } a(c.arg); } var r; o(this, "_invoke", { value: function value(t, n) { function callInvokeWithMethodAndArg() { return new e(function (e, r) { invoke(t, n, e, r); }); } return r = r ? r.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); } function makeInvokeMethod(e, r, n) { var o = h; return function (i, a) { if (o === f) throw Error("Generator is already running"); if (o === s) { if ("throw" === i) throw a; return { value: t, done: !0 }; } for (n.method = i, n.arg = a;;) { var c = n.delegate; if (c) { var u = maybeInvokeDelegate(c, n); if (u) { if (u === y) continue; return u; } } if ("next" === n.method) n.sent = n._sent = n.arg;else if ("throw" === n.method) { if (o === h) throw o = s, n.arg; n.dispatchException(n.arg); } else "return" === n.method && n.abrupt("return", n.arg); o = f; var p = tryCatch(e, r, n); if ("normal" === p.type) { if (o = n.done ? s : l, p.arg === y) continue; return { value: p.arg, done: n.done }; } "throw" === p.type && (o = s, n.method = "throw", n.arg = p.arg); } }; } function maybeInvokeDelegate(e, r) { var n = r.method, o = e.iterator[n]; if (o === t) return r.delegate = null, "throw" === n && e.iterator.return && (r.method = "return", r.arg = t, maybeInvokeDelegate(e, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), y; var i = tryCatch(o, e.iterator, r.arg); if ("throw" === i.type) return r.method = "throw", r.arg = i.arg, r.delegate = null, y; var a = i.arg; return a ? a.done ? (r[e.resultName] = a.value, r.next = e.nextLoc, "return" !== r.method && (r.method = "next", r.arg = t), r.delegate = null, y) : a : (r.method = "throw", r.arg = new TypeError("iterator result is not an object"), r.delegate = null, y); } function pushTryEntry(t) { var e = { tryLoc: t[0] }; 1 in t && (e.catchLoc = t[1]), 2 in t && (e.finallyLoc = t[2], e.afterLoc = t[3]), this.tryEntries.push(e); } function resetTryEntry(t) { var e = t.completion || {}; e.type = "normal", delete e.arg, t.completion = e; } function Context(t) { this.tryEntries = [{ tryLoc: "root" }], t.forEach(pushTryEntry, this), this.reset(!0); } function values(e) { if (e || "" === e) { var r = e[a]; if (r) return r.call(e); if ("function" == typeof e.next) return e; if (!isNaN(e.length)) { var o = -1, i = function next() { for (; ++o < e.length;) if (n.call(e, o)) return next.value = e[o], next.done = !1, next; return next.value = t, next.done = !0, next; }; return i.next = i; } } throw new TypeError(_typeof(e) + " is not iterable"); } return GeneratorFunction.prototype = GeneratorFunctionPrototype, o(g, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), o(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, u, "GeneratorFunction"), e.isGeneratorFunction = function (t) { var e = "function" == typeof t && t.constructor; return !!e && (e === GeneratorFunction || "GeneratorFunction" === (e.displayName || e.name)); }, e.mark = function (t) { return Object.setPrototypeOf ? Object.setPrototypeOf(t, GeneratorFunctionPrototype) : (t.__proto__ = GeneratorFunctionPrototype, define(t, u, "GeneratorFunction")), t.prototype = Object.create(g), t; }, e.awrap = function (t) { return { __await: t }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, c, function () { return this; }), e.AsyncIterator = AsyncIterator, e.async = function (t, r, n, o, i) { void 0 === i && (i = Promise); var a = new AsyncIterator(wrap(t, r, n, o), i); return e.isGeneratorFunction(r) ? a : a.next().then(function (t) { return t.done ? t.value : a.next(); }); }, defineIteratorMethods(g), define(g, u, "Generator"), define(g, a, function () { return this; }), define(g, "toString", function () { return "[object Generator]"; }), e.keys = function (t) { var e = Object(t), r = []; for (var n in e) r.push(n); return r.reverse(), function next() { for (; r.length;) { var t = r.pop(); if (t in e) return next.value = t, next.done = !1, next; } return next.done = !0, next; }; }, e.values = values, Context.prototype = { constructor: Context, reset: function reset(e) { if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(resetTryEntry), !e) for (var r in this) "t" === r.charAt(0) && n.call(this, r) && !isNaN(+r.slice(1)) && (this[r] = t); }, stop: function stop() { this.done = !0; var t = this.tryEntries[0].completion; if ("throw" === t.type) throw t.arg; return this.rval; }, dispatchException: function dispatchException(e) { if (this.done) throw e; var r = this; function handle(n, o) { return a.type = "throw", a.arg = e, r.next = n, o && (r.method = "next", r.arg = t), !!o; } for (var o = this.tryEntries.length - 1; o >= 0; --o) { var i = this.tryEntries[o], a = i.completion; if ("root" === i.tryLoc) return handle("end"); if (i.tryLoc <= this.prev) { var c = n.call(i, "catchLoc"), u = n.call(i, "finallyLoc"); if (c && u) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } else if (c) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); } else { if (!u) throw Error("try statement without catch or finally"); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } } } }, abrupt: function abrupt(t, e) { for (var r = this.tryEntries.length - 1; r >= 0; --r) { var o = this.tryEntries[r]; if (o.tryLoc <= this.prev && n.call(o, "finallyLoc") && this.prev < o.finallyLoc) { var i = o; break; } } i && ("break" === t || "continue" === t) && i.tryLoc <= e && e <= i.finallyLoc && (i = null); var a = i ? i.completion : {}; return a.type = t, a.arg = e, i ? (this.method = "next", this.next = i.finallyLoc, y) : this.complete(a); }, complete: function complete(t, e) { if ("throw" === t.type) throw t.arg; return "break" === t.type || "continue" === t.type ? this.next = t.arg : "return" === t.type ? (this.rval = this.arg = t.arg, this.method = "return", this.next = "end") : "normal" === t.type && e && (this.next = e), y; }, finish: function finish(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.finallyLoc === t) return this.complete(r.completion, r.afterLoc), resetTryEntry(r), y; } }, catch: function _catch(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.tryLoc === t) { var n = r.completion; if ("throw" === n.type) { var o = n.arg; resetTryEntry(r); } return o; } } throw Error("illegal catch attempt"); }, delegateYield: function delegateYield(e, r, n) { return this.delegate = { iterator: values(e), resultName: r, nextLoc: n }, "next" === this.method && (this.arg = t), y; } }, e; }
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // Import statements
...
var addProject = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(formData, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          projectId = _args.length > 2 && _args[2] !== undefined ? _args[2] : null;
          url = "".concat((0, _baseUrl.getBaseUrl)(), "/api/v1/projects");
          if (!(type === "create")) {
            _context.next = 6;
            break;
          }
        ...
        case 6:
          ...
          url = "".concat(url, "/").concat(projectId);
          method = "patch";
          _context.next = 13;
          break;
        case 11:
          (0, _alert.showAlert)("error", "Invalid operation type or missing project ID for update.");
        ...
        case 16:
          res = _context.sent;
          if (res.data.status === "success") {
            message = type === "create" ? "Project added successfully" : "Project updated successfully";
            (0, _alert.showAlert)("success", message);

            // Redirect after success
            redirectUrl = "/admin/myWork";
            location.assign(redirectUrl);
          } else {
            (0, _alert.showAlert)("error", "Unexpected status: ".concat(res.data.status));
          }
          _context.next = 23;
          break;
        case 20:
  ...
  return function addProject(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

// Usage in the form handler
var handleProjectFormSubmit = exports.handleProjectFormSubmit = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(form, actionType) {
    var projectId,
      _args3 = arguments;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          projectId = _args3.length > 2 && _args3[2] !== undefined ? _args3[2] : null;
          form.addEventListener("submit", /*#__PURE__*/function () {
            var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
              var title, description, liveUrl, githubUrl, technologies, desktopImg, mobileImg, formData;
              return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                while (1) switch (_context2.prev = _context2.next) {
                  case 0:
                    e.preventDefault();
                    ...
                    // Extract form data
                    title = document.querySelector("#new-project-title").value;
                    description = document.querySelector("#description").value;
                    liveUrl = document.querySelector("#live-url").value;
                    githubUrl = document.querySelector("#github-url").value; // Extract selected technologies (checkboxes)
                    technologies = Array.from(document.querySelectorAll('input[name="technologies"]:checked')).map(function (checkbox) {
                      return checkbox.value;
                    }); // Extract image files
                    desktopImg = document.querySelector("#desktop-img").files[0];
                    mobileImg = document.querySelector("#mobile-img").files[0]; // Create FormData object
                    formData = new FormData();
                    formData.append("title", title);
                    ...
                    _context2.next = 18;
                    return addProject(formData, actionType, projectId);
                  case 18:
                  case "end":
                    return _context2.stop();
                }
  ...
  return function handleProjectFormSubmit(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js","./baseUrl":"baseUrl.js"}],"index.js":[function(require,module,exports) {
var define;
"use strict";
...
var _alert = require("./alert");
var _baseUrl = require("./baseUrl");
var _updateFn = require("./updateFn.js");
...
var createPostForm = document.querySelector("#postForm");
var userDataForm = document.querySelector("#form-user-data");
var updateSocialForm = document.querySelector(".updateSocial");
...
document.addEventListener("DOMContentLoaded", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
  var sidebar, _sidebar, deleteButtons, _yield$fetchTrafficDa, dailyCount, monthlyCount, allTimeCount;
  return _regeneratorRuntime().wrap(function _callee4$(_context4) {
    while (1) switch (_context4.prev = _context4.next) {
      case 0:
        if (loginForm) {
          ...
          loginForm.addEventListener("submit", function (e) {
            ...
            (0, _updateFn.login)(email, password);
          });
        }
        if (signupForm) {
          ...
          signupForm.addEventListener("submit", function (e) {
            ...
            var passwordConfirm = document.getElementById("sg-passwordConfirm").value;
            (0, _updateFn.signup)(name, email, password, passwordConfirm);
          });
        }
        if (logoutBtn) {
        ...
        if (createPostForm) {
          (0, _updateFn.initializeImagePreview)("#iPNGimg", "#new-post-img");
          createPostForm.addEventListener("submit", function (e) {
            ...
            var newPostImg = document.getElementById("new-post-img").files[0];
            var type = postId ? "update" : "create";
            (0, _updateFn.handlePostSubmit)(title, content, excerpt, tags, category, newPostImg, "author",
        ...
        if (userDataForm) {
          userDataForm.addEventListener("submit", function (e) {
            ...
            (0, _updateFn.updateSettings)(form, "data");
          });
        }
        if (updateSocialForm) {
          updateSocialForm.addEventListener("submit", function (e) {
            e.preventDefault();
            var form = e.target;
            ...
            (0, _updateFn.updateSettings)(data, "socials");
          });
        }
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    _context.next = 7;
                    return (0, _updateFn.updateSettings)({
              ...
              return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                while (1) switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    _context2.next = 6;
                    return (0, _updateFn.createContactUs)(name, email, message, contactForm);
                  case 6:
        ...
        if (deleteButtons) {
          deleteButtons.forEach(function (button) {
            button.addEventListener("click", function (e) {
              ...
              var type = this.getAttribute("data-type"); // Get the type from data attribute
              if (confirm("Are you sure you want to delete this ".concat(type, "?"))) {
                (0, _updateFn.deleteItem)(type, id);
              }
            });
          });
        }
        if (commentForm) {
          commentForm.addEventListener("submit", /*#__PURE__*/function () {
            var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
              var form, postId, name, email, comment;
              return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                while (1) switch (_context3.prev = _context3.next) {
                  case 0:
                    e.preventDefault();
                    ...
                    _context3.next = 8;
                    return (0, _updateFn.createComment)(postId, name, email, comment);
                  case 8:
                  case "end":
                    return _context3.stop();
                }
        ...
        // Fetch Traffic Data
        _context4.next = 13;
        return (0, _updateFn.fetchTrafficData)();
      case 13:
        _yield$fetchTrafficDa = _context4.sent;
        dailyCount = _yield$fetchTrafficDa.dailyCount;
        monthlyCount = _yield$fetchTrafficDa.monthlyCount;
        allTimeCount = _yield$fetchTrafficDa.allTimeCount;
        document.getElementById("dailyCount").innerText = (0, _updateFn.formatNumber)(dailyCount);
        document.getElementById("monthlyCount").innerText = (0, _updateFn.formatNumber)(monthlyCount);
        document.getElementById("allTimeCount").innerText = (0, _updateFn.formatNumber)(allTimeCount);
        ...
        document.getElementById("monthly").querySelector("span").innerText = monthlyCount;
        document.getElementById("allTime").querySelector("span").innerText = allTimeCount;
      case 23:
      case "end":
        return _context4.stop();
    }
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var editProjectForm = document.querySelector("#editProject");
  if (createProjectForm) {
    (0, _createProject.handleProjectFormSubmit)(createProjectForm, "create");
  }
  if (editProjectForm) {
    var projectId = editProjectForm.dataset.projectId;
    (0, _createProject.handleProjectFormSubmit)(editProjectForm, "update", projectId);
  }
  var itemPurchaseForm = document.querySelector("#purchase-form");
  if (itemPurchaseForm) {
    itemPurchaseForm.addEventListener("submit", /*#__PURE__*/function () {
      var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(e) {
        var email, name, itemId, price;
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              e.preventDefault();
              email = document.getElementById("email").value;
              name = document.getElementById("name").value;
              itemId = itemPurchaseForm.dataset.itemId;
              price = itemPurchaseForm.dataset.price; // Accessing the price
              try {
                ...
                FlutterwaveCheckout({
                  ...
                  callback: function callback(data) {
                    return (0, _updateFn.handlePaymentCallback)(data, itemId, name, email, price);
                  },
                  customizations: {
                    title: "Dev Memoirs",
                ...
                (0, _alert.showAlert)("error", "There was an error initiating the payment, Please try again later");
                (0, _alert.showAlert)("error", "Error initiating payment:");
              }
            case 6:
            case "end":
              return _context5.stop();
  ...
  var submitReviews = document.querySelector("#submit-review");
  if (submitReviews) {
    submitReviews.addEventListener("submit", /*#__PURE__*/function () {
      var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(e) {
        var form, itemId, rating, reviewTitle, reviewContent, purchaseSecret, data;
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              e.preventDefault();
              ...
              reviewTitle = form.querySelector("#review-title").value;
              reviewContent = form.querySelector("textarea").value;
              purchaseSecret = form.getAttribute("data-purchase-secret");
              data = {
                title: reviewTitle,
              ...
              _context6.prev = 8;
              _context6.next = 11;
              return (0, _updateFn.createReview)(data, purchaseSecret);
            case 11:
              _context6.next = 16;
              break;
            case 13:
              ...
              (0, _alert.showAlert)("error", "There was an error submitting your review.");
            case 16:
            case "end":
              return _context6.stop();
          }
  ...
  var verifyToDownloadItem = document.querySelector(".verify-to-download-form");
  if (verifyToDownloadItem) {
    var verifyButton = document.querySelector(".access-download");
    var verifyBtn = document.querySelector(".access-download button.action");
    verifyButton.addEventListener("submit", /*#__PURE__*/function () {
      var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(e) {
        var form, email, itemId;
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              e.preventDefault();
              ...
              itemId = form.getAttribute("data-purchased-item-id"); // Ensure email and itemId are provided
              if (!(!email || !itemId)) {
                _context7.next = 7;
                break;
              }
              (0, _alert.showAlert)("error", "Please provide your email.");
            ...
            case 7:
              ...
              _context7.next = 11;
              return (0, _updateFn.verifyEmailFn)(email, itemId);
            case 11:
              setTimeout(function () {
  ...
  var redirectForm = document.querySelector(".redirect-form");
  if (redirectForm) {
    ...
    var interval = setInterval(function () {
      count--;
      counter.innerText = "If you're not redirected in ".concat(count, " seconds,");
      if (count === 0) {
        clearInterval(interval);
      }
    }, 1000);
    redirectForm.addEventListener("submit", /*#__PURE__*/function () {
        ...
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            case 0:
              e.preventDefault();
              form = e.target;
              email = document.querySelector("#redirect-email").value.trim();
              itemId = document.querySelector("#item").value.trim(); // Ensure email and itemId are provided
              if (!(!email || !itemId)) {
                _context8.next = 7;
                break;
              }
            ...
            case 14:
              ...
              (0, _alert.showAlert)("error", "Verification failed. Please try again.");
            case 17:
              _context8.prev = 17;
  ...
  var createItemForm = document.querySelector("#createItem");
  if (createItemForm) {
    createItemForm.addEventListener("submit", /*#__PURE__*/function () {
      var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(e) {
        var form, name, description, price, priceDiscount, itemImg, zipFile, formData;
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              e.preventDefault();
              form = e.target;
              name = form.querySelector("#new-item-name").value;
              description = form.querySelector("#description").value;
              price = form.querySelector("#price").value;
              priceDiscount = form.querySelector("#priceDiscount").value;
              itemImg = form.querySelector("#itemImg").files[0];
              zipFile = form.querySelector("#zipFile").files[0]; // Create FormData object
              formData = new FormData();
              ...
              _context9.prev = 15;
              _context9.next = 18;
              return (0, _updateFn.createItem)(formData);
            case 18:
              _context9.next = 23;
              break;
            case 20:
              ...
              (0, _alert.showAlert)("error", "There was an error creating the item.");
            case 23:
            case "end":
              return _context9.stop();
          }
  ...
  var newCategory = document.querySelector(".post-group.categories");
  if (newCategory) {
    var addCatBtn = document.querySelector("#addNewCat");
    var addCatDiv = document.querySelector(".new-category");
    var closeCat = document.querySelector("#cancel");
    if (addCatBtn && addCatDiv && closeCat) {
      ...
      closeCat.addEventListener("click", function (e) {
        e.preventDefault();
        addCatDiv.classList.remove("addCat");
        document.body.style.overflow = "";
      });
    }
    var addCatForm = document.querySelector("#add-category-form");
    if (addCatForm) {
      addCatForm.addEventListener("submit", /*#__PURE__*/function () {
          ...
          return _regeneratorRuntime().wrap(function _callee10$(_context10) {
            while (1) switch (_context10.prev = _context10.next) {
              case 0:
                ...
                _context10.prev = 5;
                _context10.next = 8;
                return (0, _updateFn.addCategory)(data);
              case 8:
                _context10.next = 13;
                break;
              case 10:
                ...
                (0, _alert.showAlert)("error", "Error adding category:", _context10.t0);
              case 13:
              case "end":
                return _context10.stop();
            }
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "3977" + '/');
